...
Brainiac is a generic, local retrieval and maintenance layer for plain-file knowledge vaults. It keeps durable knowledge in ordinary files, builds an incremental SQLite index, and lets an operator retrieve bounded context safely.
